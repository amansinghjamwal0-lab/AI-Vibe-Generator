...
# API Key Setup (Aapki di hui key yahan add kar di hai)
GOOGLE_API_KEY = "AQ.Ab8RN6K1FhNjc1AbkLUDLjxlA5NQe5ocM0qwHKz0yfY9JPSA2Q" 
        ...
        with st.spinner("Decoding your vibe... 🌌"):
            try:
                ...
                {{
                    ...
                    "description": "A short poetic description of this aesthetic vibe",
                    "music_genre": "Recommended music style or playlist type",
                    "outfit_idea": "Quick description of an outfit matching this vibe"
                }}
                """
                ...
                # Detailed Info Card with Bright White Text
                st.markdown(f"""
                <div class="vibe-card" style="color: #ffffff;">
                    <h4 style="color: #00f3ff;">📖 Aesthetic Description</h4>
                    <p style="color: #ffffff;">{vibe_data['description']}</p>
                    <h4 style="color: #ff007f;">🎵 Suggested Soundtrack</h4>
                    <p style="color: #ffffff;">{vibe_data['music_genre']}</p>
                    <h4 style="color: #00f3ff;">🧥 Outfit Inspiration</h4>
